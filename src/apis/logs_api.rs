...
pub async fn get_logs(configuration: &configuration::Configuration, logs_request_body: crate::models::LogsRequestBody) -> Result<std::path::PathBuf, Error<GetLogsError>> {
