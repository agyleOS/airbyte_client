...
/// struct for typed errors of method [`create_or_update_state`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateOrUpdateStateError {
...
/// struct for typed errors of method [`save_stats`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SaveStatsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`save_sync_config`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SaveSyncConfigError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`set_workflow_in_attempt`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SetWorkflowInAttemptError {
    UnknownValue(serde_json::Value),
}
...
pub async fn create_or_update_state(
    ...
    connection_state_create_or_update: crate::models::ConnectionStateCreateOrUpdate,
) -> Result<crate::models::ConnectionState, Error<CreateOrUpdateStateError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&connection_state_create_or_update);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateOrUpdateStateError> =
...
pub async fn save_stats(
    configuration: &configuration::Configuration,
    save_stats_request_body: crate::models::SaveStatsRequestBody,
) -> Result<crate::models::InternalOperationResult, Error<SaveStatsError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&save_stats_request_body);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SaveStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn save_sync_config(
    configuration: &configuration::Configuration,
    save_attempt_sync_config_request_body: crate::models::SaveAttemptSyncConfigRequestBody,
) -> Result<crate::models::InternalOperationResult, Error<SaveSyncConfigError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&save_attempt_sync_config_request_body);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SaveSyncConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_workflow_in_attempt(
    configuration: &configuration::Configuration,
    set_workflow_in_attempt_request_body: crate::models::SetWorkflowInAttemptRequestBody,
) -> Result<crate::models::InternalOperationResult, Error<SetWorkflowInAttemptError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&set_workflow_in_attempt_request_body);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetWorkflowInAttemptError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
