...
/// struct for typed errors of method [`create_stream_status`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateStreamStatusError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_stream_statuses`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetStreamStatusesError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`update_stream_status`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateStreamStatusError {
    UnknownValue(serde_json::Value),
}

pub async fn create_stream_status(
    configuration: &configuration::Configuration,
    stream_status_create_request_body: Option<crate::models::StreamStatusCreateRequestBody>,
) -> Result<crate::models::StreamStatusRead, Error<CreateStreamStatusError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&stream_status_create_request_body);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateStreamStatusError> =
...
pub async fn get_stream_statuses(
    configuration: &configuration::Configuration,
    stream_status_list_request_body: Option<crate::models::StreamStatusListRequestBody>,
) -> Result<crate::models::StreamStatusReadList, Error<GetStreamStatusesError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&stream_status_list_request_body);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStreamStatusesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_stream_status(
    configuration: &configuration::Configuration,
    stream_status_update_request_body: Option<crate::models::StreamStatusUpdateRequestBody>,
) -> Result<crate::models::StreamStatusRead, Error<UpdateStreamStatusError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&stream_status_update_request_body);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateStreamStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
