...
pub async fn get_open_api_spec(configuration: &configuration::Configuration, ) -> Result<std::path::PathBuf, Error<GetOpenApiSpecError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetOpenApiSpecError> = serde_json::from_str(&local_var_content).ok();
