...
pub async fn try_notification_config(
    configuration: &configuration::Configuration,
    notification: crate::models::Notification,
) -> Result<crate::models::NotificationRead, Error<TryNotificationConfigError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TryNotificationConfigError> =
