...
/// struct for typed errors of method [`get_specification_for_destination_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSpecificationForDestinationIdError {
    Status404(crate::models::NotFoundKnownExceptionInfo),
    Status422(crate::models::InvalidInputExceptionInfo),
    UnknownValue(serde_json::Value),
}

pub async fn get_destination_definition_specification(
    configuration: &configuration::Configuration,
    destination_definition_id_with_workspace_id: crate::models::DestinationDefinitionIdWithWorkspaceId,
) -> Result<
    crate::models::DestinationDefinitionSpecificationRead,
    Error<GetDestinationDefinitionSpecificationError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDestinationDefinitionSpecificationError> =
...
pub async fn get_specification_for_destination_id(
    configuration: &configuration::Configuration,
    destination_id_request_body: crate::models::DestinationIdRequestBody,
) -> Result<
    crate::models::DestinationDefinitionSpecificationRead,
    Error<GetSpecificationForDestinationIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSpecificationForDestinationIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
