...
pub async fn complete_destination_o_auth(
    configuration: &configuration::Configuration,
    complete_destination_o_auth_request: crate::models::CompleteDestinationOAuthRequest,
) -> Result<crate::models::CompleteOAuthResponse, Error<CompleteDestinationOAuthError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CompleteDestinationOAuthError> =
...
pub async fn get_destination_o_auth_consent(
    configuration: &configuration::Configuration,
    destination_oauth_consent_request: crate::models::DestinationOauthConsentRequest,
) -> Result<crate::models::OAuthConsentRead, Error<GetDestinationOAuthConsentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDestinationOAuthConsentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_instancewide_destination_oauth_params(
    configuration: &configuration::Configuration,
    set_instancewide_destination_oauth_params_request_body: crate::models::SetInstancewideDestinationOauthParamsRequestBody,
) -> Result<(), Error<SetInstancewideDestinationOauthParamsError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&set_instancewide_destination_oauth_params_request_body);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetInstancewideDestinationOauthParamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
