...
/// struct for typed errors of method [`get_source_definition_specification`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSourceDefinitionSpecificationError {
    Status404(crate::models::NotFoundKnownExceptionInfo),
    Status422(crate::models::InvalidInputExceptionInfo),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_specification_for_source_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSpecificationForSourceIdError {
    Status404(crate::models::NotFoundKnownExceptionInfo),
    Status422(crate::models::InvalidInputExceptionInfo),
    UnknownValue(serde_json::Value),
}

pub async fn get_source_definition_specification(
    configuration: &configuration::Configuration,
    source_definition_id_with_workspace_id: crate::models::SourceDefinitionIdWithWorkspaceId,
) -> Result<
    crate::models::SourceDefinitionSpecificationRead,
    Error<GetSourceDefinitionSpecificationError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSourceDefinitionSpecificationError> =
...
pub async fn get_specification_for_source_id(
    configuration: &configuration::Configuration,
    source_id_request_body: crate::models::SourceIdRequestBody,
) -> Result<crate::models::SourceDefinitionSpecificationRead, Error<GetSpecificationForSourceIdError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSpecificationForSourceIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
