...
pub async fn web_backend_list_all_connections_for_workspace(configuration: &configuration::Configuration, workspace_id_request_body: crate::models::WorkspaceIdRequestBody) -> Result<crate::models::WebBackendConnectionReadList, Error<WebBackendListAllConnectionsForWorkspaceError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/web_backend/connections/list_all", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<WebBackendListAllConnectionsForWorkspaceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn web_backend_list_connections_for_workspace(configuration: &configuration::Configuration, workspace_id_request_body: crate::models::WorkspaceIdRequestBody) -> Result<crate::models::WebBackendConnectionReadList, Error<WebBackendListConnectionsForWorkspaceError>> {
    let local_var_configuration = configuration;
...
pub async fn web_backend_search_connections(configuration: &configuration::Configuration, web_backend_connection_search: crate::models::WebBackendConnectionSearch) -> Result<crate::models::WebBackendConnectionReadList, Error<WebBackendSearchConnectionsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/web_backend/connections/search", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<WebBackendSearchConnectionsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
