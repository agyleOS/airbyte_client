...
/// struct for typed errors of method [`get_workspace_by_connection_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetWorkspaceByConnectionIdError {
    Status404(crate::models::NotFoundKnownExceptionInfo),
    Status422(crate::models::InvalidInputExceptionInfo),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`update_workspace_name`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateWorkspaceNameError {
    Status404(crate::models::NotFoundKnownExceptionInfo),
    Status422(crate::models::InvalidInputExceptionInfo),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_workspace_by_connection_id(
    configuration: &configuration::Configuration,
    connection_id_request_body: crate::models::ConnectionIdRequestBody,
) -> Result<crate::models::WorkspaceRead, Error<GetWorkspaceByConnectionIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetWorkspaceByConnectionIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_workspace_name(
    configuration: &configuration::Configuration,
    workspace_update_name: crate::models::WorkspaceUpdateName,
) -> Result<crate::models::WorkspaceRead, Error<UpdateWorkspaceNameError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&workspace_update_name);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateWorkspaceNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
