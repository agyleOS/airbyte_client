...
pub struct DestinationSearch {
    #[serde(rename = "destinationDefinitionId", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "connectionConfiguration", skip_serializing_if = "Option::is_none")]
