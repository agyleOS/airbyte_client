...
pub enum ConnectionScheduleType {
    #[serde(rename = "manual")]
    Manual,
    #[serde(rename = "basic")]
    Basic,
...
impl ToString for ConnectionScheduleType {
    fn to_string(&self) -> String {
        match self {
            Self::Manual => String::from("manual"),
            Self::Basic => String::from("basic"),
            Self::Cron => String::from("cron"),
        }
    }
}

impl Default for ConnectionScheduleType {
    fn default() -> ConnectionScheduleType {
        Self::Manual
    }
}
