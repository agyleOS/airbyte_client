...
impl ConnectionRead {
    pub fn new(connection_id: String, name: String, source_id: String, destination_id: String, sync_catalog: crate::models::AirbyteCatalog, status: crate::models::ConnectionStatus) -> ConnectionRead {
        ConnectionRead {
            connection_id,
            name,
