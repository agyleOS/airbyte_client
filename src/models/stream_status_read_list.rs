...
pub struct StreamStatusReadList {
    #[serde(rename = "streamStatuses", skip_serializing_if = "Option::is_none")]
    pub stream_statuses: Option<Vec<crate::models::StreamStatusRead>>,
}

impl StreamStatusReadList {
    pub fn new() -> StreamStatusReadList {
        StreamStatusReadList {
            stream_statuses: None,
        }
    }
}
