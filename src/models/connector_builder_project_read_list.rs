...
pub struct ConnectorBuilderProjectReadList {
    #[serde(rename = "projects")]
    pub projects: Vec<crate::models::ConnectorBuilderProjectDetailsRead>,
}

impl ConnectorBuilderProjectReadList {
    pub fn new(
        projects: Vec<crate::models::ConnectorBuilderProjectDetailsRead>,
    ) -> ConnectorBuilderProjectReadList {
        ConnectorBuilderProjectReadList { projects }
    }
}
