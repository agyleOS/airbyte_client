...
pub struct OperationReadList {
    #[serde(rename = "operations")]
    pub operations: Vec<crate::models::OperationRead>,
}

impl OperationReadList {
    pub fn new(operations: Vec<crate::models::OperationRead>) -> OperationReadList {
