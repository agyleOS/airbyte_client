...
pub struct ConnectionScheduleData {
    #[serde(rename = "basicSchedule", skip_serializing_if = "Option::is_none")]
    pub basic_schedule: Option<Box<crate::models::ConnectionScheduleDataBasicSchedule>>,
    #[serde(rename = "cron", skip_serializing_if = "Option::is_none")]
    pub cron: Option<Box<crate::models::ConnectionScheduleDataCron>>,
}

impl ConnectionScheduleData {
    /// schedule for when the the connection should run, per the schedule type
    pub fn new() -> ConnectionScheduleData {
