...
pub struct SourceDefinitionReadList {
    #[serde(rename = "sourceDefinitions")]
    pub source_definitions: Vec<crate::models::SourceDefinitionRead>,
}

impl SourceDefinitionReadList {
    pub fn new(
        source_definitions: Vec<crate::models::SourceDefinitionRead>,
    ) -> SourceDefinitionReadList {
        SourceDefinitionReadList { source_definitions }
    }
}
