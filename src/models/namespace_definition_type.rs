...
pub enum NamespaceDefinitionType {
    #[serde(rename = "source")]
    Source,
...
impl ToString for NamespaceDefinitionType {
    fn to_string(&self) -> String {
        match self {
            Self::Source => String::from("source"),
            Self::Destination => String::from("destination"),
            Self::Customformat => String::from("customformat"),
        }
    }
}

impl Default for NamespaceDefinitionType {
    fn default() -> NamespaceDefinitionType {
        Self::Source
    }
}
