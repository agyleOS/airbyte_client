...
pub struct OperatorWebhookDbtCloud {
...
impl OperatorWebhookDbtCloud {
    pub fn new(account_id: i32, job_id: i32) -> OperatorWebhookDbtCloud {
        OperatorWebhookDbtCloud { account_id, job_id }
    }
}
