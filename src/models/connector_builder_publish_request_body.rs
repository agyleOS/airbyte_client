...
pub struct ConnectorBuilderPublishRequestBody {
    #[serde(rename = "workspaceId")]
    pub workspace_id: uuid::Uuid,
    #[serde(rename = "builderProjectId")]
    pub builder_project_id: uuid::Uuid,
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "initialDeclarativeManifest")]
    pub initial_declarative_manifest: Box<crate::models::DeclarativeSourceManifest>,
}

impl ConnectorBuilderPublishRequestBody {
    pub fn new(
        workspace_id: uuid::Uuid,
        builder_project_id: uuid::Uuid,
        name: String,
        initial_declarative_manifest: crate::models::DeclarativeSourceManifest,
    ) -> ConnectorBuilderPublishRequestBody {
        ConnectorBuilderPublishRequestBody {
            workspace_id,
            builder_project_id,
            name,
            initial_declarative_manifest: Box::new(initial_declarative_manifest),
        }
    }
}
