...
pub struct ConnectionStateCreateOrUpdate {
    #[serde(rename = "connectionId")]
    pub connection_id: uuid::Uuid,
    #[serde(rename = "connectionState")]
    pub connection_state: Box<crate::models::ConnectionState>,
}

impl ConnectionStateCreateOrUpdate {
    pub fn new(
        connection_id: uuid::Uuid,
        connection_state: crate::models::ConnectionState,
    ) -> ConnectionStateCreateOrUpdate {
        ConnectionStateCreateOrUpdate {
            connection_id,
            connection_state: Box::new(connection_state),
        }
    }
}
