...
pub struct SaveAttemptSyncConfigRequestBody {
    #[serde(rename = "jobId")]
    pub job_id: i64,
    #[serde(rename = "attemptNumber")]
    pub attempt_number: i32,
    #[serde(rename = "syncConfig")]
    pub sync_config: Box<crate::models::AttemptSyncConfig>,
}

impl SaveAttemptSyncConfigRequestBody {
    pub fn new(
        job_id: i64,
        attempt_number: i32,
        sync_config: crate::models::AttemptSyncConfig,
    ) -> SaveAttemptSyncConfigRequestBody {
        SaveAttemptSyncConfigRequestBody {
            job_id,
            attempt_number,
            sync_config: Box::new(sync_config),
        }
    }
}
