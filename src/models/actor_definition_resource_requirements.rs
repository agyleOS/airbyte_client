...
pub struct ActorDefinitionResourceRequirements {
    #[serde(rename = "default", skip_serializing_if = "Option::is_none")]
    pub default: Option<Box<crate::models::ResourceRequirements>>,
    #[serde(rename = "jobSpecific", skip_serializing_if = "Option::is_none")]
    pub job_specific: Option<Vec<crate::models::JobTypeResourceLimit>>,
}

impl ActorDefinitionResourceRequirements {
    /// actor definition specific resource requirements. if default is set, these are the requirements that should be set for ALL jobs run for this actor definition. it is overriden by the job type specific configurations. if not set, the platform will use defaults. these values will be overriden by configuration at the connection level.
    pub fn new() -> ActorDefinitionResourceRequirements {
