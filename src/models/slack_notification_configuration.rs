...
pub struct SlackNotificationConfiguration {
    #[serde(rename = "webhook")]
    pub webhook: String,
}

impl SlackNotificationConfiguration {
    pub fn new(webhook: String) -> SlackNotificationConfiguration {
        SlackNotificationConfiguration { webhook }
    }
}
