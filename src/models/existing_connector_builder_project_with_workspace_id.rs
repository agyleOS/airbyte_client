...
pub struct ExistingConnectorBuilderProjectWithWorkspaceId {
    #[serde(rename = "workspaceId")]
    pub workspace_id: uuid::Uuid,
    #[serde(rename = "builderProjectId")]
    pub builder_project_id: uuid::Uuid,
    #[serde(rename = "builderProject")]
    pub builder_project: Box<crate::models::ConnectorBuilderProjectDetails>,
}

impl ExistingConnectorBuilderProjectWithWorkspaceId {
    pub fn new(
        workspace_id: uuid::Uuid,
        builder_project_id: uuid::Uuid,
        builder_project: crate::models::ConnectorBuilderProjectDetails,
