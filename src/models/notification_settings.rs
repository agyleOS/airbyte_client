...
pub struct NotificationSettings {
    #[serde(rename = "sendOnSuccess", skip_serializing_if = "Option::is_none")]
    pub send_on_success: Option<Box<crate::models::NotificationItem>>,
    #[serde(rename = "sendOnFailure", skip_serializing_if = "Option::is_none")]
    pub send_on_failure: Option<Box<crate::models::NotificationItem>>,
    #[serde(rename = "sendOnSyncDisabled", skip_serializing_if = "Option::is_none")]
    pub send_on_sync_disabled: Option<Box<crate::models::NotificationItem>>,
    #[serde(
        rename = "sendOnSyncDisabledWarning",
        skip_serializing_if = "Option::is_none"
    )]
    pub send_on_sync_disabled_warning: Option<Box<crate::models::NotificationItem>>,
    #[serde(
        rename = "sendOnConnectionUpdate",
        skip_serializing_if = "Option::is_none"
    )]
    pub send_on_connection_update: Option<Box<crate::models::NotificationItem>>,
    #[serde(
        rename = "sendOnConnectionUpdateActionRequired",
        skip_serializing_if = "Option::is_none"
    )]
    pub send_on_connection_update_action_required: Option<Box<crate::models::NotificationItem>>,
}
...
impl NotificationSettings {
    pub fn new() -> NotificationSettings {
        NotificationSettings {
            ...
            send_on_failure: None,
            send_on_sync_disabled: None,
            send_on_sync_disabled_warning: None,
            send_on_connection_update: None,
            send_on_connection_update_action_required: None,
        }
    }
}
