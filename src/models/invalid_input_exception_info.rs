...
pub struct InvalidInputExceptionInfo {
    ...
    pub validation_errors: Vec<crate::models::InvalidInputProperty>,
}

impl InvalidInputExceptionInfo {
    pub fn new(message: String, validation_errors: Vec<crate::models::InvalidInputProperty>) -> InvalidInputExceptionInfo {
