...
pub struct AttemptInfoRead {
    #[serde(rename = "attempt")]
    pub attempt: Box<crate::models::AttemptRead>,
    #[serde(rename = "logs")]
    pub logs: Box<crate::models::LogRead>,
}

impl AttemptInfoRead {
    pub fn new(attempt: crate::models::AttemptRead, logs: crate::models::LogRead) -> AttemptInfoRead {
        AttemptInfoRead {
