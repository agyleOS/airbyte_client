...
pub struct JobInfoLightRead {
    #[serde(rename = "job")]
    pub job: Box<crate::models::JobRead>,
}

impl JobInfoLightRead {
    pub fn new(job: crate::models::JobRead) -> JobInfoLightRead {
        JobInfoLightRead { job: Box::new(job) }
    }
}
