...
pub struct ConnectorBuilderProjectDetailsRead {
    #[serde(rename = "name")]
    pub name: String,
    ...
    #[serde(
        rename = "activeDeclarativeManifestVersion",
        skip_serializing_if = "Option::is_none"
    )]
    pub active_declarative_manifest_version: Option<i64>,
    #[serde(rename = "hasDraft")]
    pub has_draft: bool,
}

impl ConnectorBuilderProjectDetailsRead {
    pub fn new(
        name: String,
        ...
        ConnectorBuilderProjectDetailsRead {
            ...
            active_declarative_manifest_version: None,
            has_draft,
        }
    }
}
