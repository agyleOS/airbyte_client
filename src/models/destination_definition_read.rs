...
impl DestinationDefinitionRead {
    pub fn new(destination_definition_id: String, name: String, docker_repository: String, docker_image_tag: String, documentation_url: String) -> DestinationDefinitionRead {
