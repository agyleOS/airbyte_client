...
pub struct DestinationDefinitionSpecificationRead {
    ...
    #[serde(rename = "connectionSpecification", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "supportedDestinationSyncModes", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "supportsNormalization", skip_serializing_if = "Option::is_none")]
    pub supports_normalization: Option<bool>,
}

impl DestinationDefinitionSpecificationRead {
    pub fn new(destination_definition_id: String, job_info: crate::models::SynchronousJobRead) -> DestinationDefinitionSpecificationRead {
