...
pub struct DestinationCloneRequestBody {
    #[serde(rename = "destinationCloneId")]
    pub destination_clone_id: uuid::Uuid,
    #[serde(
        rename = "destinationConfiguration",
        skip_serializing_if = "Option::is_none"
    )]
    pub destination_configuration: Option<Box<crate::models::DestinationCloneConfiguration>>,
}

impl DestinationCloneRequestBody {
    ...
    pub fn new(destination_clone_id: uuid::Uuid) -> DestinationCloneRequestBody {
