...
pub struct OAuthConfigSpecification {
    /// OAuth specific blob.
    #[serde(rename = "oauthUserInputFromConnectorConfigSpecification", skip_serializing_if = "Option::is_none")]
    pub oauth_user_input_from_connector_config_specification: Option<serde_json::Value>,
    /// OAuth specific blob.
    #[serde(rename = "completeOAuthOutputSpecification", skip_serializing_if = "Option::is_none")]
    pub complete_o_auth_output_specification: Option<serde_json::Value>,
    /// OAuth specific blob.
    #[serde(rename = "completeOAuthServerInputSpecification", skip_serializing_if = "Option::is_none")]
    pub complete_o_auth_server_input_specification: Option<serde_json::Value>,
    /// OAuth specific blob.
    #[serde(rename = "completeOAuthServerOutputSpecification", skip_serializing_if = "Option::is_none")]
