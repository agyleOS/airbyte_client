...
pub struct AirbyteStreamAndConfiguration {
    #[serde(rename = "stream", skip_serializing_if = "Option::is_none")]
    pub stream: Option<Box<crate::models::AirbyteStream>>,
    #[serde(rename = "config", skip_serializing_if = "Option::is_none")]
    pub config: Option<Box<crate::models::AirbyteStreamConfiguration>>,
}

impl AirbyteStreamAndConfiguration {
    /// each stream is split in two parts; the immutable schema from source and mutable configuration for destination
    pub fn new() -> AirbyteStreamAndConfiguration {
