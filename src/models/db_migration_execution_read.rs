...
pub struct DbMigrationExecutionRead {
    #[serde(rename = "initialVersion", skip_serializing_if = "Option::is_none")]
    pub initial_version: Option<String>,
    #[serde(rename = "targetVersion", skip_serializing_if = "Option::is_none")]
    pub target_version: Option<String>,
    #[serde(rename = "executedMigrations", skip_serializing_if = "Option::is_none")]
    pub executed_migrations: Option<Vec<crate::models::DbMigrationRead>>,
}

impl DbMigrationExecutionRead {
    pub fn new() -> DbMigrationExecutionRead {
        DbMigrationExecutionRead {
            initial_version: None,
            target_version: None,
            executed_migrations: None,
        }
    }
}
