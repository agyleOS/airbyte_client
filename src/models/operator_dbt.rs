...
pub struct OperatorDbt {
    #[serde(rename = "gitRepoUrl")]
    pub git_repo_url: String,
    #[serde(rename = "gitRepoBranch", skip_serializing_if = "Option::is_none")]
    pub git_repo_branch: Option<String>,
    #[serde(rename = "dockerImage", skip_serializing_if = "Option::is_none")]
    pub docker_image: Option<String>,
    #[serde(rename = "dbtArguments", skip_serializing_if = "Option::is_none")]
    pub dbt_arguments: Option<String>,
}

impl OperatorDbt {
    pub fn new(git_repo_url: String) -> OperatorDbt {
        OperatorDbt {
            git_repo_url,
