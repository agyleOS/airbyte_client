...
pub struct FieldSchemaUpdate {
    /// JSONSchema representation of the field
    #[serde(rename = "oldSchema")]
...
impl FieldSchemaUpdate {
    pub fn new(old_schema: serde_json::Value, new_schema: serde_json::Value) -> FieldSchemaUpdate {
        FieldSchemaUpdate {
            old_schema,
            new_schema,
        }
