...
pub struct ConnectionReadList {
    #[serde(rename = "connections")]
    pub connections: Vec<crate::models::ConnectionRead>,
}

impl ConnectionReadList {
    pub fn new(connections: Vec<crate::models::ConnectionRead>) -> ConnectionReadList {
        ConnectionReadList { connections }
    }
}
