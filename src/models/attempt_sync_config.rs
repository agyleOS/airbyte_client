...
pub struct AttemptSyncConfig {
    ...
    pub destination_configuration: Option<serde_json::Value>,
    #[serde(rename = "state", skip_serializing_if = "Option::is_none")]
    pub state: Option<Box<crate::models::ConnectionState>>,
}

impl AttemptSyncConfig {
    pub fn new(
        source_configuration: Option<serde_json::Value>,
        destination_configuration: Option<serde_json::Value>,
    ) -> AttemptSyncConfig {
        AttemptSyncConfig {
