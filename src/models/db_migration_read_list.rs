...
pub struct DbMigrationReadList {
    #[serde(rename = "migrations", skip_serializing_if = "Option::is_none")]
    pub migrations: Option<Vec<crate::models::DbMigrationRead>>,
}

impl DbMigrationReadList {
    pub fn new() -> DbMigrationReadList {
        DbMigrationReadList { migrations: None }
    }
}
