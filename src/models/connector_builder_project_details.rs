...
pub struct ConnectorBuilderProjectDetails {
    #[serde(rename = "name")]
    pub name: String,
    /// Low code CDK manifest JSON object
    #[serde(rename = "draftManifest", skip_serializing_if = "Option::is_none")]
    pub draft_manifest: Option<serde_json::Value>,
}

impl ConnectorBuilderProjectDetails {
    pub fn new(name: String) -> ConnectorBuilderProjectDetails {
