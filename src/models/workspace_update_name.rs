...
pub struct WorkspaceUpdateName {
...
impl WorkspaceUpdateName {
    pub fn new(workspace_id: uuid::Uuid, name: String) -> WorkspaceUpdateName {
        WorkspaceUpdateName { workspace_id, name }
    }
}
