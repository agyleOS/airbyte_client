...
pub struct ConnectionScheduleDataCron {
    #[serde(rename = "cronExpression")]
    pub cron_expression: String,
    #[serde(rename = "cronTimeZone")]
    pub cron_time_zone: String,
}

impl ConnectionScheduleDataCron {
    pub fn new(cron_expression: String, cron_time_zone: String) -> ConnectionScheduleDataCron {
