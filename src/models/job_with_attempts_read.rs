...
pub struct JobWithAttemptsRead {
    #[serde(rename = "job", skip_serializing_if = "Option::is_none")]
    pub job: Option<Box<crate::models::JobRead>>,
    #[serde(rename = "attempts", skip_serializing_if = "Option::is_none")]
    pub attempts: Option<Vec<crate::models::AttemptRead>>,
}

impl JobWithAttemptsRead {
    pub fn new() -> JobWithAttemptsRead {
        JobWithAttemptsRead {
            job: None,
            attempts: None,
        }
