...
pub struct ActorDefinitionRequestBody {
    #[serde(rename = "actorDefinitionId")]
    pub actor_definition_id: uuid::Uuid,
    #[serde(rename = "actorType")]
    pub actor_type: crate::models::ActorType,
}

impl ActorDefinitionRequestBody {
    pub fn new(
        actor_definition_id: uuid::Uuid,
        actor_type: crate::models::ActorType,
