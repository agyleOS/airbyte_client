...
impl SourceCoreConfig {
    pub fn new(source_definition_id: String, connection_configuration: Option<serde_json::Value>) -> SourceCoreConfig {
        SourceCoreConfig {
