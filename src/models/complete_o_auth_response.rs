...
pub struct CompleteOAuthResponse {
    #[serde(rename = "request_succeeded")]
    pub request_succeeded: bool,
    #[serde(rename = "request_error", skip_serializing_if = "Option::is_none")]
    pub request_error: Option<String>,
    #[serde(rename = "auth_payload")]
    pub auth_payload: ::std::collections::HashMap<String, serde_json::Value>,
}

impl CompleteOAuthResponse {
    pub fn new(
        request_succeeded: bool,
        auth_payload: ::std::collections::HashMap<String, serde_json::Value>,
