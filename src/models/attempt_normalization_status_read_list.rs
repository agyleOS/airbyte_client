...
pub struct AttemptNormalizationStatusReadList {
    #[serde(
        rename = "attemptNormalizationStatuses",
        skip_serializing_if = "Option::is_none"
    )]
    pub attempt_normalization_statuses: Option<Vec<crate::models::AttemptNormalizationStatusRead>>,
}

impl AttemptNormalizationStatusReadList {
    pub fn new() -> AttemptNormalizationStatusReadList {
        AttemptNormalizationStatusReadList {
            attempt_normalization_statuses: None,
        }
    }
}
