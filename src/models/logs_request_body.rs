...
pub struct LogsRequestBody {
    #[serde(rename = "logType")]
    pub log_type: crate::models::LogType,
}

impl LogsRequestBody {
    pub fn new(log_type: crate::models::LogType) -> LogsRequestBody {
        LogsRequestBody { log_type }
    }
}
