...
/// StreamStatusRunState : Values:   * `PENDING` - The stream operation has been selected to run   * `RUNNING` - The stream operation is running   * `COMPLETE` - The stream operation ran successfully to completion   * `INCOMPLETE` - The stream operation has terminated in an incomplete state.   See StreamStatusIncompleteRunCause for more details.

/// Values:   * `PENDING` - The stream operation has been selected to run   * `RUNNING` - The stream operation is running   * `COMPLETE` - The stream operation ran successfully to completion   * `INCOMPLETE` - The stream operation has terminated in an incomplete state.   See StreamStatusIncompleteRunCause for more details.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum StreamStatusRunState {
...
impl ToString for StreamStatusRunState {
...
impl Default for StreamStatusRunState {
    fn default() -> StreamStatusRunState {
        Self::Pending
    }
}
