...
pub struct SetWorkflowInAttemptRequestBody {
    #[serde(rename = "jobId")]
    pub job_id: i64,
    ...
    #[serde(
        rename = "processingTaskQueue",
        skip_serializing_if = "Option::is_none"
    )]
    pub processing_task_queue: Option<String>,
}

impl SetWorkflowInAttemptRequestBody {
    pub fn new(
        job_id: i64,
        attempt_number: i32,
        workflow_id: String,
