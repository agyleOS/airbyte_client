...
pub struct SourceDiscoverSchemaWriteRequestBody {
    #[serde(rename = "catalog")]
    pub catalog: Box<crate::models::AirbyteCatalog>,
    #[serde(rename = "sourceId", skip_serializing_if = "Option::is_none")]
    pub source_id: Option<uuid::Uuid>,
    #[serde(rename = "connectorVersion", skip_serializing_if = "Option::is_none")]
    pub connector_version: Option<String>,
    #[serde(rename = "configurationHash", skip_serializing_if = "Option::is_none")]
    pub configuration_hash: Option<String>,
}

impl SourceDiscoverSchemaWriteRequestBody {
    /// to write this requested object to database.
    pub fn new(catalog: crate::models::AirbyteCatalog) -> SourceDiscoverSchemaWriteRequestBody {
