...
pub struct GlobalState {
    #[serde(rename = "shared_state", skip_serializing_if = "Option::is_none")]
    pub shared_state: Option<serde_json::Value>,
    #[serde(rename = "streamStates")]
    pub stream_states: Vec<crate::models::StreamState>,
}

impl GlobalState {
    pub fn new(stream_states: Vec<crate::models::StreamState>) -> GlobalState {
        GlobalState {
            shared_state: None,
            stream_states,
        }
