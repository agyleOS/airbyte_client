...
pub struct WorkspaceReadList {
    #[serde(rename = "workspaces")]
    pub workspaces: Vec<crate::models::WorkspaceRead>,
}

impl WorkspaceReadList {
    pub fn new(workspaces: Vec<crate::models::WorkspaceRead>) -> WorkspaceReadList {
