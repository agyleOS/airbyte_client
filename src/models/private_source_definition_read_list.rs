...
pub struct PrivateSourceDefinitionReadList {
    #[serde(rename = "sourceDefinitions")]
    pub source_definitions: Vec<crate::models::PrivateSourceDefinitionRead>,
}

impl PrivateSourceDefinitionReadList {
    pub fn new(
        source_definitions: Vec<crate::models::PrivateSourceDefinitionRead>,
    ) -> PrivateSourceDefinitionReadList {
        PrivateSourceDefinitionReadList { source_definitions }
    }
}
