...
pub struct SynchronousJobRead {
    ...
    pub succeeded: bool,
    #[serde(
        rename = "connectorConfigurationUpdated",
        skip_serializing_if = "Option::is_none"
    )]
    pub connector_configuration_updated: Option<bool>,
    #[serde(rename = "logs", skip_serializing_if = "Option::is_none")]
    pub logs: Option<Box<crate::models::LogRead>>,
    #[serde(rename = "failureReason", skip_serializing_if = "Option::is_none")]
    pub failure_reason: Option<Box<crate::models::FailureReason>>,
}
...
impl SynchronousJobRead {
    pub fn new(
        ...
        SynchronousJobRead {
            ...
            ended_at,
            succeeded,
            connector_configuration_updated: None,
            logs: None,
            failure_reason: None,
        }
    }
