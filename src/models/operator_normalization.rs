...
pub struct OperatorNormalization {
    ...
    pub option: Option<OperatorNormalizationOption>,
}

impl OperatorNormalization {
    pub fn new() -> OperatorNormalization {
        OperatorNormalization { option: None }
    }
}

///
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum OperatorNormalizationOption {
    #[serde(rename = "basic")]
    Basic,
}

impl Default for OperatorNormalizationOption {
    fn default() -> OperatorNormalizationOption {
        Self::Basic
    }
}
