...
pub struct OperatorNormalization {
    ...
    pub option: Option<NormalizationOption>,
}

impl OperatorNormalization {
    pub fn new(option: Option<NormalizationOption>) -> OperatorNormalization {
        OperatorNormalization { option }
    }
}
...
impl Default for NormalizationOption {
    fn default() -> NormalizationOption {
        Self::Basic
    }
}
