...
pub struct NotificationItem {
    ...
    pub notification_type: Option<Vec<crate::models::NotificationType>>,
    ...
    #[serde(
        rename = "customerioConfiguration",
        skip_serializing_if = "Option::is_none"
    )]
    pub customerio_configuration: Option<serde_json::Value>,
}

impl NotificationItem {
    pub fn new() -> NotificationItem {
        NotificationItem {
