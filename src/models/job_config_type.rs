...
pub enum JobConfigType {
    #[serde(rename = "check_connection_source")]
    CheckConnectionSource,
    #[serde(rename = "check_connection_destination")]
...
impl ToString for JobConfigType {
    fn to_string(&self) -> String {
        match self {
            Self::CheckConnectionSource => String::from("check_connection_source"),
            Self::CheckConnectionDestination => String::from("check_connection_destination"),
...
impl Default for JobConfigType {
    fn default() -> JobConfigType {
        Self::CheckConnectionSource
    }
}
