...
pub struct WebBackendConnectionRead {
    ...
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "namespaceDefinition", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "latestSyncJobCreatedAt", skip_serializing_if = "Option::is_none")]
    pub latest_sync_job_created_at: Option<i64>,
    #[serde(rename = "latestSyncJobStatus", skip_serializing_if = "Option::is_none")]
...
impl WebBackendConnectionRead {
    pub fn new(connection_id: String, name: String, source_id: String, destination_id: String, sync_catalog: crate::models::AirbyteCatalog, status: crate::models::ConnectionStatus, source: crate::models::SourceRead, destination: crate::models::DestinationRead, is_syncing: bool) -> WebBackendConnectionRead {
