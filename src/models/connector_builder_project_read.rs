...
pub struct ConnectorBuilderProjectRead {
    #[serde(rename = "builderProject")]
    pub builder_project: Box<crate::models::ConnectorBuilderProjectDetailsRead>,
    #[serde(
        rename = "declarativeManifest",
        skip_serializing_if = "Option::is_none"
    )]
    pub declarative_manifest: Option<Box<crate::models::DeclarativeManifestRead>>,
}

impl ConnectorBuilderProjectRead {
    pub fn new(
        builder_project: crate::models::ConnectorBuilderProjectDetailsRead,
    ) -> ConnectorBuilderProjectRead {
        ConnectorBuilderProjectRead {
            builder_project: Box::new(builder_project),
            declarative_manifest: None,
        }
    }
}
