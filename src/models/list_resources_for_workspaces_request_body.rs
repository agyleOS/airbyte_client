...
pub struct ListResourcesForWorkspacesRequestBody {
...
impl ListResourcesForWorkspacesRequestBody {
    pub fn new(workspace_ids: Vec<uuid::Uuid>) -> ListResourcesForWorkspacesRequestBody {
