...
pub struct AttemptNormalizationStatusRead {
    #[serde(rename = "attemptNumber", skip_serializing_if = "Option::is_none")]
    pub attempt_number: Option<i32>,
    #[serde(
        rename = "hasRecordsCommitted",
        skip_serializing_if = "Option::is_none"
    )]
    pub has_records_committed: Option<bool>,
    #[serde(rename = "recordsCommitted", skip_serializing_if = "Option::is_none")]
    pub records_committed: Option<i64>,
    #[serde(
        rename = "hasNormalizationFailed",
        skip_serializing_if = "Option::is_none"
    )]
    pub has_normalization_failed: Option<bool>,
}

impl AttemptNormalizationStatusRead {
    pub fn new() -> AttemptNormalizationStatusRead {
        AttemptNormalizationStatusRead {
            attempt_number: None,
            has_records_committed: None,
            records_committed: None,
            has_normalization_failed: None,
        }
    }
}
