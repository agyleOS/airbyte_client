...
pub struct ResetConfig {
    #[serde(rename = "streamsToReset", skip_serializing_if = "Option::is_none")]
    pub streams_to_reset: Option<Vec<crate::models::StreamDescriptor>>,
}

impl ResetConfig {
    /// contains information about how a reset was configured. only populated if the job was a reset.
    pub fn new() -> ResetConfig {
        ResetConfig {
            streams_to_reset: None,
        }
    }
}
