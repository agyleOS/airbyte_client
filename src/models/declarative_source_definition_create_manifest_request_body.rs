...
pub struct DeclarativeSourceDefinitionCreateManifestRequestBody {
    #[serde(rename = "workspaceId")]
    pub workspace_id: uuid::Uuid,
    #[serde(rename = "sourceDefinitionId")]
    pub source_definition_id: uuid::Uuid,
    #[serde(rename = "setAsActiveManifest")]
    pub set_as_active_manifest: bool,
    #[serde(rename = "declarativeManifest")]
    pub declarative_manifest: Box<crate::models::DeclarativeSourceManifest>,
}

impl DeclarativeSourceDefinitionCreateManifestRequestBody {
    pub fn new(
        workspace_id: uuid::Uuid,
        source_definition_id: uuid::Uuid,
        set_as_active_manifest: bool,
        declarative_manifest: crate::models::DeclarativeSourceManifest,
    ) -> DeclarativeSourceDefinitionCreateManifestRequestBody {
        DeclarativeSourceDefinitionCreateManifestRequestBody {
            workspace_id,
            source_definition_id,
            set_as_active_manifest,
            declarative_manifest: Box::new(declarative_manifest),
        }
    }
}
