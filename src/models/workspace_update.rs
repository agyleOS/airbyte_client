...
pub struct WorkspaceUpdate {
    ...
    #[serde(
        rename = "initialSetupComplete",
        skip_serializing_if = "Option::is_none"
    )]
    pub initial_setup_complete: Option<bool>,
    ...
    pub notification_settings: Option<Box<crate::models::NotificationSettings>>,
...
impl WorkspaceUpdate {
    ...
    pub fn new(workspace_id: uuid::Uuid) -> WorkspaceUpdate {
        WorkspaceUpdate {
            workspace_id,
            email: None,
            initial_setup_complete: None,
