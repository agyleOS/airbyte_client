...
pub struct DeclarativeManifestsReadList {
    #[serde(rename = "manifestVersions")]
    pub manifest_versions: Vec<crate::models::DeclarativeManifestVersionRead>,
}

impl DeclarativeManifestsReadList {
    pub fn new(
        manifest_versions: Vec<crate::models::DeclarativeManifestVersionRead>,
    ) -> DeclarativeManifestsReadList {
        DeclarativeManifestsReadList { manifest_versions }
    }
}
