...
pub struct WebBackendConnectionListRequestBody {
...
impl WebBackendConnectionListRequestBody {
    pub fn new(workspace_id: uuid::Uuid) -> WebBackendConnectionListRequestBody {
