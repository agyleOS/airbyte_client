...
pub struct PrivateDestinationDefinitionReadList {
    #[serde(rename = "destinationDefinitions")]
    pub destination_definitions: Vec<crate::models::PrivateDestinationDefinitionRead>,
}

impl PrivateDestinationDefinitionReadList {
    pub fn new(
        destination_definitions: Vec<crate::models::PrivateDestinationDefinitionRead>,
