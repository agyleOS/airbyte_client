...
/// StreamStatusIncompleteRunCause : Values:   * `FAILED` - A failure has occurred   * `CANCELED` - The run has been canceled

/// Values:   * `FAILED` - A failure has occurred   * `CANCELED` - The run has been canceled
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum StreamStatusIncompleteRunCause {
    #[serde(rename = "FAILED")]
    Failed,
...
impl ToString for StreamStatusIncompleteRunCause {
...
impl Default for StreamStatusIncompleteRunCause {
    fn default() -> StreamStatusIncompleteRunCause {
        Self::Failed
    }
}
