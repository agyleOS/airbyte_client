...
pub struct WebBackendGeographiesListResult {
    #[serde(rename = "geographies")]
    pub geographies: Vec<crate::models::Geography>,
}

impl WebBackendGeographiesListResult {
    pub fn new(geographies: Vec<crate::models::Geography>) -> WebBackendGeographiesListResult {
        WebBackendGeographiesListResult { geographies }
    }
}
