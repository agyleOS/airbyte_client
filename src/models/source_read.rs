...
impl SourceRead {
    pub fn new(source_definition_id: String, source_id: String, workspace_id: String, connection_configuration: Option<serde_json::Value>, name: String, source_name: String) -> SourceRead {
        SourceRead {
