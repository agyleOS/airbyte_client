...
pub struct ConnectionStreamRequestBody {
    #[serde(rename = "connectionId")]
    pub connection_id: uuid::Uuid,
    #[serde(rename = "streams")]
    pub streams: Vec<crate::models::ConnectionStream>,
}

impl ConnectionStreamRequestBody {
    pub fn new(
        connection_id: uuid::Uuid,
        streams: Vec<crate::models::ConnectionStream>,
