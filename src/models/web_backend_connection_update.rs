...
pub struct WebBackendConnectionUpdate {
    ...
    #[serde(rename = "withRefreshedCatalog", skip_serializing_if = "Option::is_none")]
...
impl WebBackendConnectionUpdate {
    pub fn new(connection_id: String, sync_catalog: crate::models::AirbyteCatalog, status: crate::models::ConnectionStatus) -> WebBackendConnectionUpdate {
