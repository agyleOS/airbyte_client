...
pub struct ConnectionScheduleDataBasicSchedule {
...
impl ConnectionScheduleDataBasicSchedule {
    pub fn new(time_unit: TimeUnit, units: i64) -> ConnectionScheduleDataBasicSchedule {
        ConnectionScheduleDataBasicSchedule { time_unit, units }
    }
}
